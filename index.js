...
import { URLs } from './user-data/urls.js';
  ...
  const { pentestProjects, ctiProjects, redteamProjects, osintProjects } =
    projects;
  ...
  populateProjects(pentestProjects, "pentest-projects");
  populateProjects(ctiProjects, "cti-projects");
  populateProjects(redteamProjects, "redteam-projects");
  populateProjects(osintProjects, "osint-projects");
